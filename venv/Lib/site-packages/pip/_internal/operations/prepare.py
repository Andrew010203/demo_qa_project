...
def get_http_url(
    ...
    # If a down dir is specified, is the file already downloaded there?
...
def get_file_url(
    ...
    # If a down dir is specified, is the file already there and valid?
    already_downloaded_path = None
    if download_dir:
        already_downloaded_path = _check_download_dir(link, download_dir, hashes)
...
class RequirementPreparer:
    ...
    def _complete_partial_requirements(
        ...
        # needed for downstream 'down', 'wheel', and 'install' commands.
        ...
        # successfully by the 'down', 'wheel', and 'install' commands.
        for req in partially_downloaded_reqs:
